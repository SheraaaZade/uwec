...
public class Kaleidoscope {
	private final ShapeVector theShapes;
	private final List<KaleidoscopeView> theViews;
	private final ShapeFactory theFactory;
	private final ShapeMutationStrategy theStrategy;
